        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 mb-12 sm:mb-16">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="flex gap-4">
              <a href="https://wa.me/256701949311" target="_blank" rel="noopener noreferrer" className="group" title="WhatsApp">
                <div className="w-10 h-10 rounded-full glass-morphism flex items-center justify-center border border-white/10 group-hover:border-[#25D366] group-hover:shadow-[0_0_15px_rgba(37,211,102,0.3)] transition-all duration-300">
              ...
              <a href="https://t.me/abantechnologies" target="_blank" rel="noopener noreferrer" className="group" title="Telegram">
                <div className="w-10 h-10 rounded-full glass-morphism flex items-center justify-center border border-white/10 group-hover:border-[#229ED9] group-hover:shadow-[0_0_15px_rgba(34,158,217,0.3)] transition-all duration-300">
              ...
              <a href="https://x.com/abantech1" target="_blank" rel="noopener noreferrer" className="group" title="X (Twitter)">
                <div className="w-10 h-10 rounded-full glass-morphism flex items-center justify-center border border-white/10 group-hover:border-white group-hover:shadow-[0_0_15px_rgba(255,255,255,0.2)] transition-all duration-300">
              ...
              <a href="https://www.instagram.com/abantechnologies1?igsh=MXQ3bHV5cnVvZWoxMQ==" target="_blank" rel="noopener noreferrer" className="group" title="Instagram">
                <div className="w-10 h-10 rounded-full glass-morphism flex items-center justify-center border border-white/10 group-hover:border-[#E1306C] group-hover:shadow-[0_0_15px_rgba(225,48,108,0.3)] transition-all duration-300">
                  <Instagram className="w-5 h-5 text-muted-foreground group-hover:text-[#E1306C] transition-colors" />
                </div>
              </a>
              <a href="https://github.com/abankabaka/Abantech" target="_blank" rel="noopener noreferrer" className="group" title="GitHub">
                <div className="w-10 h-10 rounded-full glass-morphism flex items-center justify-center border border-white/10 group-hover:border-white group-hover:shadow-[0_0_15px_rgba(255,255,255,0.2)] transition-all duration-300">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <ul className="space-y-3">
              {['Ecosystem', 'About', 'Services', 'Projects'].map((item) => (
                <li key={item}>
                  <Link href={`#${item.toLowerCase()}`} className="text-muted-foreground hover:text-primary hover:translate-x-1 transition-all duration-300 inline-block">
                    {item}
                  </Link>
                </li>
              ))}
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3 group">
                <div className="mt-1 w-8 h-8 rounded-lg bg-secondary/50 flex items-center justify-center border border-white/5 group-hover:border-primary/30 transition-colors">
                  <Phone className="w-4 h-4 text-primary" />
                </div>
                <div className="flex flex-col gap-1">
                  <a href="tel:+256701949311" className="text-muted-foreground hover:text-foreground transition-colors">+256 701 949 311</a>
                  <a href="tel:+256763180375" className="text-muted-foreground hover:text-foreground transition-colors">+256 763 180 375</a>
                </div>
              </li>
              <li className="flex items-start gap-3 group">
                <a 
                ...
                >
                  ...
                  <span className="text-muted-foreground group-hover:text-foreground break-all transition-colors pt-1">
